  ...
  actions: {
    ...
    async connectFacebook() {
      try {
        ...
        window.dispatchEvent(new CustomEvent('communityglows:android-oauth-request-started', {
          detail: {
            networkId: 'facebook',
            state: requestState,
            nonce: requestNonce,
        ...
        return new Promise((resolve, reject) => {
          ...
          const finishWithError = (error: Error) => {
            ...
            window.removeEventListener('communityglows:android-oauth-callback-validated', onAndroidOAuthCallback)
          ...
          window.addEventListener('communityglows:android-oauth-callback-validated', onAndroidOAuthCallback)
        })
      } catch (error) {
