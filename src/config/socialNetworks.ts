...
export const builtInSocialNetworks: BuiltInSocialNetwork[] = [
  ...
  },
  {
    ...
    url: 'https://nostr.com/',
    icon: 'pi pi-bolt',
    // CommunityGlows-owned presentation fallback; Nostr is a protocol without a canonical brand color.
    color: '#7C3AED',
    tileColor: '#7C3AED',
    onboarding: true,
    defaultSelected: false,
  ...
  // Sales tools: presentation colors are CommunityGlows fallbacks, not official brand claims.
  {
    id: 'breakcold',
    label: 'Breakcold',
    route: '/breakcold',
    url: 'https://us.breakcold.com/login',
    icon: 'pi pi-briefcase',
    color: '#2563EB',
    onboarding: true,
    defaultSelected: false,
  ...
  },
  {
    ...
    // Personal CRM; CommunityGlows presentation fallback, not an official brand color.
    color: '#2563EB',
    onboarding: true,
    defaultSelected: false,
  },
