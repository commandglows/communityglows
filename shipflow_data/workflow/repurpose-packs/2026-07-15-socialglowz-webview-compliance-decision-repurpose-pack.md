...
depends_on:
  - artifact: "shipflow_data/workflow/audits/2026-07-15-google-play-android-compliance.md"
    artifact_version: "1.0.0"
...
- Surface: `shipflow_data/workflow/audits/2026-07-15-google-play-android-compliance.md`.
...
- Surface: `shipflow_data/workflow/changelog.md`.
...
- Owner skill: `200-sg-redact`.
  Recommended command: `/200-sg-redact Draft a public FAQ and a release-note entry from shipflow_data/workflow/repurpose-packs/2026-07-15-socialglowz-webview-compliance-decision-repurpose-pack.md after implementation proof is available`.
