...
depends_on:
  ...
  - artifact: "shipflow_data/technical/public-webview-platform-boundary.md"
    artifact_version: "1.0.0"
    required_status: reviewed
  - artifact: "shipflow_data/workflow/explorations/2026-08-03-social-platform-compliant-product-directions.md"
    artifact_version: "1.3.0"
    required_status: reviewed
  - artifact: "shipflow_data/workflow/research/social-messaging-crm-compliance.md"
...
- Documentation de conformité : `shipflow_data/technical/public-webview-platform-boundary.md` et `shipflow_data/workflow/research/social-messaging-crm-compliance.md`.
...
- Mettre à jour `shipflow_data/technical/context.md` et `context-function-tree.md` avec la nouvelle route, le store de tâche, la capture popup et l’entrée Android partagée.
- Mettre à jour `shipflow_data/technical/extension-parity-map.md` si l’entrée popup ou les permissions changent.
- Mettre à jour `shipflow_data/technical/public-webview-platform-boundary.md` seulement si une intégration modifie réellement les capacités de WebView; cette spec ne l’autorise pas.
- Ajouter la note de version utilisateur à `shipflow_data/workflow/changelog.md` lorsque la fonctionnalité est livrée.
- Ne pas modifier les documents historiques dans `archive/`.
...
- [ ] Task 8: Vérifier les frontières et documenter la livraison.
  - Files: `README.md`, `shipflow_data/technical/context.md`, `shipflow_data/technical/context-function-tree.md`, `shipflow_data/technical/extension-parity-map.md`, `shipflow_data/workflow/changelog.md`.
