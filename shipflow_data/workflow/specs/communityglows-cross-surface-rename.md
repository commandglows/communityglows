...
evidence:
  ...
  - "shipflow_data/technical/context.md defines Convex Auth, Tauri deep links, WebView sessions, sync and billing boundaries."
  - "shipflow_data/workflow/repurpose-packs/2026-08-03-verbatim-socialglowz-renaming.md preserves the naming decision conversation."
  - "shipflow_data/workflow/explorations/2026-08-03-social-platform-compliant-product-directions.md defines the Community Relationship OS direction and preserved platform boundaries."
...
- Source de vérité produit : le nom public CommunityGlows et le domaine communityglows.com, avec `shipflow_data/business/branding.md`, `product.md`, `gtm.md` et le README alignés avant les surfaces dérivées.
...
- Les valeurs visuelles restent dans les carriers déclarés par `shipflow_data/technical/design-system-authority.md`; aucun hardcode visuel ne doit être ajouté pour le rebrand.
...
- Manual checklist : créer `shipflow_data/workflow/test-checklists/communityglows-cross-surface-rename.md` pendant l'implémentation, avec preuve horodatée par surface.
...
- Update canonical product/brand/GTM/technical docs: `README.md`, `AGENT.md`, `AGENTS.md`, `CLAUDE.md`, `shipflow_data/business/{product,business,branding,gtm,project-competitors-and-inspirations}.md`, `shipflow_data/technical/{context,context-function-tree,architecture,guidelines,extension-parity-map,public-webview-platform-boundary,android-webview-session-isolation,code-docs-map}.md`.
...
- Update `shipflow_data/technical/design-system-authority.md` and `shipflow_data/business/branding.md` only for the brand identity/source names; do not introduce parallel token authorities.
...
- [ ] Tâche 1 : Establish the rename matrix and compatibility allowlist before editing.
  - Fichier : `shipflow_data/workflow/test-checklists/communityglows-cross-surface-rename.md`
  ...
  - Notes : Exclude `archive/`, historic workflow records and prior specs from automatic replacement.

- [ ] Tâche 2 : Update canonical product and brand contracts.
  - Fichier : `README.md`, `shipflow_data/business/product.md`, `shipflow_data/business/business.md`, `shipflow_data/business/branding.md`, `shipflow_data/business/gtm.md`.
...
- [ ] Tâche 10 : Run cross-surface validation and document residual compatibility references.
  - Fichier : `shipflow_data/workflow/test-checklists/communityglows-cross-surface-rename.md`, `shipflow_data/technical/context.md`, `shipflow_data/technical/context-function-tree.md`, `shipflow_data/business/branding.md`.
...
- Read first: `README.md`, `AGENT.md`, `shipflow_data/technical/context.md`, `src-tauri/tauri.conf.json`, `site/src/config/site.ts`, `convex/billing.ts`.
- Implement canonical contract/docs first, then source/runtime, then domain/auth, then CI/site/release labels, then proof.
- Use `git mv`/targeted edits for source directories; do not use blind global replacement across `archive/`, old specs, bug reports, audit history, binary assets or stable IDs.
