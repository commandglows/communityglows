...
- Business context lives in `../shipglows_data/business/business.md`.
- Brand direction lives in `../shipglows_data/business/branding.md`.
- Implementation and editing guardrails live in `../shipglows_data/technical/guidelines.md`.
