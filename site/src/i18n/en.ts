export default {
  ...
  hero: {
    ...
    subtitle: 'CommunityGlows brings X, Instagram, Facebook, LinkedIn, TikTok, Discord, Reddit, Gmail and more into one profile-aware app. Switch contexts fast, keep sessions isolated, and reduce feed noise without rebuilding your workflow.',
    cta: 'Start with CommunityGlows',
