...
- `shipglows_data/technical/context.md` - situe les frontieres app, sync Convex, stores, WebViews et surfaces extension.
- `shipglows_data/technical/context-function-tree.md` - identifie les points d'integration probables: app SocialGlowz, stores, Convex, services externes.
