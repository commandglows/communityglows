...
evidence:
  - "shipglows_data/business/product.md defines target users, problems, desired outcomes, and risks."
  - "shipglows_data/workflow/TASKS.md records Android WebView isolation as completed and OAuth positive callback testing as deferred."
...
depends_on:
  ...
  - artifact: "shipglows_data/workflow/TASKS.md"
...
- `shipglows_data/business/product.md` - anchors ideas in target users: creators, operators, marketers, and small teams managing multiple social accounts.
- `shipglows_data/workflow/TASKS.md` - shows Android WebView storage isolation is complete and Android OAuth positive callback testing remains deferred.
