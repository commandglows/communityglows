...
- `shipglows_data/technical/android-webview-session-isolation.md` - confirmed the existing Android profile/network session boundary and storage limitations.
- `shipglows_data/workflow/specs/extension-tauri-feature-parity.md` - confirmed the project already identifies broad injection and internal-only surfaces as store-review risks.
