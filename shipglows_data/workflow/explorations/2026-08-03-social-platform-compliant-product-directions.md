...
- `shipglows_data/technical/context.md` — flux WebView, isolation de session, sync et frontières publiques.
- `shipglows_data/technical/context-function-tree.md` — points d'intégration existants.
- `shipglows_data/business/project-competitors-and-inspirations.md` — benchmark des workspaces multi-apps et pistes social/CRM/analytics.
- `shipglows_data/business/product.md` et `gtm.md` — cible, non-objectifs et positionnement.
