...
depends_on:
  ...
  - artifact: "/home/claude/winflowz/shipglows_data/workflow/specs/unified-suite-authentication.md"
  ...
  - artifact: "shipglows_data/workflow/specs/socialglowz-billing-entitlements-foundation.md"
    artifact_version: "0.1.0"
    required_status: "shipped"
  - artifact: "shipglows_data/workflow/specs/socialglowz-redemption-ui.md"
    artifact_version: "0.1.0"
    required_status: "shipped"
supersedes:
...
checklist_path: `shipglows_data/workflow/test-checklists/socialglowz-suite-entitlement-adapter.md`
...
- `/home/claude/winflowz/shipglows_data/workflow/specs/unified-suite-authentication.md`: suite identity and entitlement architecture.
...
- `/home/claude/socialglowz/shipglows_data/technical/context.md`
- `/home/claude/socialglowz/shipglows_data/technical/code-docs-map.md`
- `/home/claude/socialglowz/README.md`
- `/home/claude/socialglowz/CHANGELOG.md`
- `/home/claude/socialglowz/shipglows_data/workflow/TASKS.md`
- `/home/claude/winflowz/shipglows_data/workflow/specs/unified-suite-authentication.md` or a suite-auth follow-up note if product allowlist/bridge behavior changes
...
- [x] Task 1: Freeze local authority in docs and code comments.
  - Files: `convex/billing.ts`, `shipglows_data/technical/context.md`, `shipglows_data/technical/code-docs-map.md`.
...
- Lever les blocs `BLOCKED` dans `shipglows_data/workflow/test-checklists/socialglowz-suite-entitlement-adapter.md` après configuration d’une base bridge de recette.
