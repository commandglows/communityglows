...
depends_on:
  - artifact: "shipglows_data/workflow/specs/android-webview-storage-isolation.md"
...
- [x] Task 6: Update technical docs and Android QA workflow.
  - Files: `shipglows_data/technical/android-webview-session-isolation.md`, `shipglows_data/technical/context.md`, `shipglows_data/workflow/tauri-mobile.md`
  - Action: Document multi-profile mode, fallback mode, LRU bound, non-coverage changes, and the APK manual QA route.
  - Validate with: `rg -n "MULTI_PROFILE|multi-profile|ProfileStore|APK|Blacksmith|WebView" shipglows_data/technical shipglows_data/workflow/tauri-mobile.md`
