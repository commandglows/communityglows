...
- `shipglows_data/technical/context.md`: platform matrix and extension flow.
- `shipglows_data/technical/context-function-tree.md`: extension entrypoint tree if the app shell changes.
...
- [ ] Task 1: Produce an extension capability matrix.
  - File: `shipglows_data/technical/extension-parity-map.md`
  ...
  - Depends on: None.
  - Validate with: `python3 /home/claude/shipflow/tools/shipflow_metadata_lint.py shipglows_data/technical/extension-parity-map.md`.
...
- [ ] Task 15: Update project docs and changelog.
  - File: `README.md`, `AGENT.md`, `CLAUDE.md`, `shipglows_data/technical/context.md`, `shipglows_data/technical/context-function-tree.md`, `CHANGELOG.md`
