...
evidence:
  ...
  - "/home/claude/socialglowz/shipglows_data/workflow/specs/socialglowz-suite-entitlement-adapter.md:153 explicitly scoped out provider checkout integrations."
...
checklist_path: `shipglows_data/workflow/test-checklists/socialglowz-processor-agnostic-ltd-commerce.md`
...
- `/home/claude/socialglowz/shipglows_data/workflow/specs/socialglowz-suite-entitlement-adapter.md`: current suite adapter and bridge contract.
...
- `/home/claude/winflowz/shipglows_data/technical/context.md`
- `/home/claude/winflowz/shipglows_data/technical/code-docs-map.md`
...
- [ ] Task 10: Create manual checklist and run provider smoke.
  - Files: `shipglows_data/workflow/test-checklists/socialglowz-processor-agnostic-ltd-commerce.md`.
...
- Read first:
  - `/home/claude/socialglowz/shipglows_data/workflow/specs/socialglowz-suite-entitlement-adapter.md`
