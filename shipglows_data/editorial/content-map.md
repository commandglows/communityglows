...
docs_impact: yes
evidence:
  - "README.md and shipglows_data/workflow/TASKS.md serve as the public and execution surfaces."
  ...
  - "shipglows_data/workflow/research and shipglows_data/workflow/specs contain exploration and implementation context."
linked_artifacts:
...
- `shipglows_data/workflow/TASKS.md` — roadmap and execution priorities.
- `shipglows_data/workflow/AUDIT_LOG.md` — historical decision and review notes.
...
- `shipglows_data/workflow/specs/` and `shipglows_data/workflow/research/` — planning and deep-dive evidence.

## Content Routing Rules

- Use `shipglows_data/business/product.md` and `shipglows_data/business/gtm.md` when changing positioning, audience, offer, or proof assumptions.
- Use `README.md` for scope, platform coverage, and onboarding truth updates.
- Use `shipglows_data/workflow/TASKS.md` for execution shifts and sequencing changes.
- Use `shipglows_data/technical/architecture.md` and `src/*` references when introducing architecture-level changes.
...
- For technical summaries and workflow explanations, target `README.md` and `shipglows_data/workflow/TASKS.md`.
- For product truth updates, update linked artifact files in tandem (`shipglows_data/business/product.md`, `shipglows_data/business/gtm.md`) before publication-facing copy changes.
- Public claims about embedded platforms must follow `shipglows_data/technical/public-webview-platform-boundary.md`: do not advertise consent automation, anti-detection, arbitrary third-party scripts, friends-only feed filtering, forced desktop rendering, or guaranteed third-party availability.
