...
|---|---|---|---|
| Multi-platform availability | implemented | `README.md`, `shipglows_data/technical/context.md` | revalidate after release per platform matrix |
| Android auth/session hardening | implemented | `shipglows_data/technical/context.md`, specs | revalidate on security changes |
| Billing redemption and entitlement access | implemented | `shipglows_data/technical/code-docs-map.md`, `shipglows_data/workflow/specs/*` | revalidate with provider-bridge changes |
| WebView isolation behavior | implemented | `shipglows_data/technical/context.md`, `shipglows_data/technical/android-webview-session-isolation.md` | revalidate on storage/session changes |
