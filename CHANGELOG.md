...
### Security
- Kept third-party consent and platform interface decisions under user control; retained visual preferences are limited to theme, grayscale, mute, and native text zoom paths.
